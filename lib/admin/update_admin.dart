...
class update_admin extends StatefulWidget {
  const update_admin({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 240, 74, 163),
        onTap: _onItemTapped,
      ),
    );
  }
...
class _add_adminState extends State<add_admin> {
  ...
  Widget build(BuildContext context) {
    ...
    final signUpButton = Material(
      ...
      color: const Color.fromARGB(255, 240, 74, 163),
...
class remove_admin extends StatefulWidget {
  const remove_admin({Key? key}) : super(key: key);

  @override
  State<remove_admin> createState() => _remove_adminState();
}

class _remove_adminState extends State<remove_admin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold();
  }
